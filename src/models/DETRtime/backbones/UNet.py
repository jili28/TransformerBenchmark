...
class UNet(nn.Module):
    ...
    def __init__(self, input_shape = (500, 129), encChannels=(128, 256, 512), bottleneck=1024,
                 decChannels=(512, 256, 128), pools=(3, 2, 2), kernel_size=5,
                 nb_filters=64, retainDim=True, use_crf=True, output_shape=(0, 0),
                 use_residual=False, depth=0):
        """
        ...
        self.encChannels = (input,) + encChannels
